...
/*   Updated: 2023/10/29 18:06:47 by mbouyahy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	horizontal_intersection(t_data *data)
{
	...
	while (data->dist.temporary_y <= data->window_height && data->dist.temporary_y > 0\
		&& data->dist.temporary_x > 0 && data->dist.temporary_x <= data->window_width)
	{
