...
/*   Updated: 2023/11/03 17:49:42 by mbouyahy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include "/Users/mbouyahy/Desktop/MLX42/include/MLX42/MLX42.h"
# include <errno.h>
# include <fcntl.h>
# include <math.h>
# include <stdio.h>
...
int					minimap_check_wall(t_data *data, float x_value,
						float y_value);
...
void				player_moves(t_data *data, mlx_t *mlx, float x_value,
						float y_value);
...
void				draw_scene_line(t_data *data, int wallTP, int wallBP,
						int axe);
